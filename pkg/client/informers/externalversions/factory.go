...
import (
	...
	resources "github.com/gambol99/resources/pkg/client/informers/externalversions/resources"
...
func (f *sharedInformerFactory) Cloud() resources.Interface {
	return resources.New(f, f.namespace, f.tweakListOptions)
}
